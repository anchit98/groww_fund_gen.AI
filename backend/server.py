...
class QueryEngine:
    ...
    def _call_groq(self, query: str, contexts: List[Dict[str, Any]], citation_url: str, fact_hint: str = "") -> str:
        ...
        prompt = (
            ...
            "3) Respond in exactly 2 concise, natural human-like sentences.\n"
            "4) For a single-metric query, sentence 1 states the exact value and sentence 2 explains the metric in plain language.\n"
            "5) For a multi-metric same-fund query, sentence 1 must combine all requested values in one clean sentence; sentence 2 must add concise context (risk/category/portfolio behavior) without repeating values.\n"
            ...
            "8) Do not include citation lines or date footer in the response as source links are already provided.\n"
            "9) Avoid artificial phrasing like 'as per available information' or 'the fund has a specific value'.\n"
            "If insufficient context, return exactly: information unavailable.\n\n"
            "Style examples:\n"
            "- The expense ratio of Quant Flexi Cap Fund Direct Growth is 0.74%. This means the fund house charges about INR 7.4 annually for every INR 1,000 invested towards managing the fund.\n"
            "- The NAV (Net Asset Value) of Quant Flexi Cap Fund Direct Growth is INR 114.20. NAV is the per-unit market value of the mutual fund and changes daily based on the value of its underlying holdings.\n\n"
            "- Quant Flexi Cap Fund Direct Growth has an expense ratio of around 0.74-0.82%, an exit load of 1% if redeemed within 15 days, and a 2-star rating. It is a very high-risk flexi cap fund that follows active sector rotation and tends to have high portfolio churn.\n"
            "- Quant Small Cap Fund Direct Growth manages an AUM of around INR 25,821 crore, and the minimum SIP amount is INR 1,000. It is among the larger small-cap funds and is categorized under very high-risk equity funds.\n\n"
